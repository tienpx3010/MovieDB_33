...
@objc open class BWWalkthroughViewController: UIViewController, UIScrollViewDelegate {
    ...
    @IBOutlet open var pageControl: CustomPageControl?
    ...
    private func setupPageControl() {
        ...
        pageControl.dotSize = CGSize(width: 15, height: 15)
        pageControl.currentDotImage = #imageLiteral(resourceName: "icon_page_control_selected")
        pageControl.dotImage = #imageLiteral(resourceName: "icon_movies")
    ...
    fileprivate func updateUI() {
        ...
        // Hide/Show navigation and close buttons
